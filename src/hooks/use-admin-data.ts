...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "menu_area_comercial", label: "Comercial", desc: "Controle mestre do grupo Comercial" },
      { key: "menu_comercial_canal_parceiros", label: "↳ Canal Parceiros", desc: "Sub-item de Comercial — cadastro único de parceiro, contratos e vigências", child: true },
      { key: "menu_area_juridico", label: "Jurídico" },
      { key: "menu_juridico_contratos", label: "↳ Contrato de Parceria", desc: "Sub-item de Jurídico — contratos de parceria dos canais", child: true },
      { key: "juridico_renovar_contrato", label: "↳ Renovar contrato", desc: "Ação com alçada — exige concessão nominal", child: true },
      { key: "juridico_suspender_contrato", label: "↳ Suspender contrato", desc: "Ação com alçada — exige concessão nominal", child: true },
      { key: "juridico_bloquear_repasse", label: "↳ Bloquear repasse", desc: "Ação com alçada — exige concessão nominal", child: true },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "menu_admin_reservas", label: "Reserva de Posições (admin)", desc: "Posições, reservas de todos, parâmetros e modelos de e-mail" },
