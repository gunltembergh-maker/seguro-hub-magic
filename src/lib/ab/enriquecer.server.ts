...
// A consulta e a normalização do cartão CNPJ vivem num módulo compartilhado
// (src/lib/cadastro/cnpj-receita.server.ts), porque a Entrada de Demandas usa
// exatamente a mesma leitura. Comportamento idêntico ao que havia aqui.
import {
  ESPACO_MS,
  buscarCadastro,
  type Cadastro,
} from "../cadastro/cnpj-receita.server.ts";
