    ...
    <div className="flex flex-wrap items-end justify-between gap-4">
      <div>
        <h1 className="font-display text-3xl font-bold tracking-tight text-foreground md:text-4xl">
          {saudacao()}, <span className="text-primary">{primeiro}</span>.
        </h1>
        ...
        <p className="text-xs text-muted-foreground">Visão consolidada da Lavoro Seguros</p>
      </div>
      <div className="flex items-center gap-3">
        <div className="text-right text-xs text-muted-foreground">
          <div>Última atualização</div>
          <div className="font-numeric font-medium text-foreground">{fmtHora(lastUpdated)} BRT</div>
        </div>
        <Button
          variant="secondary"
          size="sm"
