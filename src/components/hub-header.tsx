        ...
        <DropdownMenuTrigger asChild>
          <button className="flex items-center gap-2 rounded-full pl-1 pr-3 py-1 hover:bg-white/10 transition-colors">
            ...
            <div className="hidden text-left md:block">
              <div className="text-xs font-medium leading-tight text-primary-foreground">{user?.name ?? "Colaborador"}</div>
              <div className="text-[11px] text-primary-foreground/80 leading-tight">{user?.email ?? ""}</div>
            </div>
          </button>
        </DropdownMenuTrigger>
