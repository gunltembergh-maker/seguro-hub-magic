...
import {
  ...
  Megaphone, Pin, ArrowRight, Calendar,
} from "lucide-react";
...
const shortcuts = [
  { label: "Financeiro", href: "/financeiro" as const, icon: Landmark },
  { label: "Jurídico", href: "/juridico" as const, icon: Scale },
  { label: "Operacional", href: "/operacional" as const, icon: Cog },
  { label: "Middle", href: "/middle" as const, icon: Layers },
  { label: "Facilities", href: "/facilities" as const, icon: Wrench },
  { label: "Garantia", href: "/garantia" as const, icon: ShieldCheck },
  { label: "Benefícios", href: "/beneficios" as const, icon: HeartPulse },
  { label: "Demais Ramos", href: "/demais-ramos" as const, icon: Boxes },
];
      ...
      <section className="mt-12">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {shortcuts.map((s) => (
            ...
            >
              <div className="mb-3 inline-flex h-11 w-11 items-center justify-center rounded-lg gradient-accent text-primary-foreground shadow-elegant">
